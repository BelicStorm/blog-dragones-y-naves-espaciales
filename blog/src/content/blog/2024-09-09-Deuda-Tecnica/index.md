...
### 5. Documentar
Este tendría que ser el dogma de todo programador, **Funcionalidad creada, Funcionalidad documentada**. Es nuestra responsabilidad no hacer caso a la voz en nuestra cabeza que nos repite que en unos meses te acordaras de lo que has programado hoy, no lo aras y luego invertirás tiempo en entender que hiciste para poder seguir programando o poder cambiarlo. Invierte tiempo en documentar que es lo que hace tu código.
