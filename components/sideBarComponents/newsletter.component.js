const SubscribeSection = () =>{
    return <div className="mt-10 brutalist bg-white lg:block">
                <form action="https://www.getrevue.co/profile/dragonesYnaves/add_subscriber" method="post" id="revue-form" name="revue-form"  target="_blank" rel="noreferrer">
                    ...
                    <div className="font-light text-sm text-gray-400">Suscribiendote, aceptas los 
                        <a className="text-gray-600" target="_blank" rel="noreferrer" href="https://www.getrevue.co/terms"> Terminos de servicio</a> y 
                        <a className="text-gray-600" target="_blank" rel="noreferrer" href="https://www.getrevue.co/privacy"> La politica de privacidad</a> de Revue.</div>
                    </form>
            </div>
}
