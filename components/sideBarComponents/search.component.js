const SearchSection = () =>{
    return <div className="mt-10 brutalist bg-white">
                <h2 className="font-light text-xl mb-5 text-center">Search the blog</h2>
                <div className="relative border rounded-sm overflow-hidden">
                    <form action="">
                        <input className="w-full relative p-5 font-light text-gray-900 border-0" type="text" name="s" id="" placeholder="Search..."/>
                        <button type="submit" className="bg-transparent border-0 absolute right-0 px-5 py-5 top-2">
